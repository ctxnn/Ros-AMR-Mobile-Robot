...
def generate_launch_description():
    ...
    default_model_path = os.path.join(pkg_share, 'urdf', 'amr_fe01.xacro')
    ...
    robot_description_file = os.path.join(pkg_share, 'urdf', 'amr_fe01.xacro')
    ...
    #     remappings=[('/cmd_vel', '/amr_fe01/cmd_vel')]
    # )
    gz_server = GzServer(
